...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Zortcoin
else
  DOCKER_EXEC echo \> \$HOME/.zortcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/zortcoin/zortcoin/pull/18288#discussion_r433189350 for
  # details.

...
This document provides guidelines for internationalization of the Zortcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zortcoin_en.ts` remains unchanged.

Zortcoin Core version 0.10.4 is now available from:

  <https://zortcoin.org/bin/zortcoin-core-0.10.4/>
...
- #6953 `43c2789` Split zortcoin-tx into its own package
- #6953 `dfe0d4d` Include zortcoin-tx binary on Debian/Ubuntu

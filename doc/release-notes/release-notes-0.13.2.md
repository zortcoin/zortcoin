Zortcoin Core version 0.13.2 is now available from:

  <https://zortcoin.org/bin/zortcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update zortcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow zortcoin-tx to create v2 transactions (ztcdrak)

Download URL: https://sourceforge.net/projects/zortcoin/files/Zortcoin/zortcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ZTC fee schedule (users still pay 0.01 ZTC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #zortcoin00 - #zortcoin99

Zortcoin Core version 0.9.2.1 is now available from:

  https://zortcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ZTC to 0.01 ZTC
...
- Fix "Start zortcoin on system login"

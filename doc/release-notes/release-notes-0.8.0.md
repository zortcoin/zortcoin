Zortcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/zortcoin/files/Zortcoin/zortcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Zortcoin
...
New/changed settings (command-line or zortcoin.conf file)
--------------------------------------------------------

Zortcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/zortcoin/files/Zortcoin/zortcoin-0.5.4/
...
http://gitorious.org/zortcoin/zortcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Zortcoin-Qt notifications under Growl 1.3.
Increase required age of Zortcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxZortcoin properly when installing Zortcoin-Qt over it. (Windows)

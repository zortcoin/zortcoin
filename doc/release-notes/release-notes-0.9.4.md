Zortcoin Core version 0.9.4 is now available from:

  https://zortcoin.org/bin/0.9.4/
...
this update is incompatible with the Zortcoin system and could lead to consensus
forks.

Zortcoin Core released binaries from https://zortcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~zortcoin/+archive/ubuntu/zortcoin
- A third-party or self-compiled Zortcoin Core

upgrade to Zortcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

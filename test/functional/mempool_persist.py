...
By default, zortcoind will dump mempool on shutdown and
...
class MempoolPersistTest(ZortcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent zortcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

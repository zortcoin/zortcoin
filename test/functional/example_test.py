...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ZortcoinTestFramework
    pass


class ExampleTest(ZortcoinTestFramework):
    # Each functional test is a subclass of the ZortcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ZortcoinTestFramework class so other tests can use it."""

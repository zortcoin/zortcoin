...
class TestShell:
    """Wrapper Class for ZortcoinTestFramework.

    The TestShell class extends the ZortcoinTestFramework
    ...
    class __TestShell(ZortcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ZortcoinTestFramework child class.
            self.num_nodes = 1

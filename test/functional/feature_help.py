...
"""Verify that starting zortcoin with -h works as expected."""

from test_framework.test_framework import ZortcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ZortcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zortcoin with -h for help text")
        ...
        self.log.info("Start zortcoin with -version for version information")
        ...
        self.log.info("Start zortcoind with -fakearg to make sure it does not start")

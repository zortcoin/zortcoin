...
// zortcoin includes.
#include <..\src\script\zortcoinconsensus.h>
...
int main()
{
    std::cout << "zortcoinconsensus version: " << zortcoinconsensus_version() << std::endl;
    ...
    auto op0Result = zortcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, zortcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

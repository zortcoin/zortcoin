...
#ifndef ZORTCOIn_POLICY_FEERATE_H
#define ZORTCOIn_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "ZTC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    ZTC_KVB,      //!< Use ZTC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from ZTC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::ZTC_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  ZORTCOIn_POLICY_FEERATE_H

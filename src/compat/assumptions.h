...
#ifndef ZORTCOIn_COMPAT_ASSUMPTIONS_H
#define ZORTCOIn_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Zortcoin cannot be compiled without assertions."
#endif
...
#endif // ZORTCOIn_COMPAT_ASSUMPTIONS_H

...
#ifndef ZORTCOIn_TEST_SCRIPTNUM10_H
#define ZORTCOIn_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Zortcoin Core 0.10.0, for cross-comparison.
 */
public:

    ...
    platformStyle(_platformStyle)
{
    ...
    // normal zortcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying zortcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ZortcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

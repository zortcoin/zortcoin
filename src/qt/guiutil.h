...
#ifndef ZORTCOIn_QT_GUIUTIL_H
#define ZORTCOIn_QT_GUIUTIL_H
...
/** Utility functions used by the Zortcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "zortcoin:" URI into recipient object, return true on successful parsing

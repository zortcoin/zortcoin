...
//! Entry point for ZortcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ZortcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ZortcoinGUI tests.
void AppTests::guiTests(ZortcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ZortcoinGUI::consoleShown, this, &AppTests::consoleTests);

    ...
    mapper(nullptr)
{
    ...
    ui->zortcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->zortcoinAtStartup);
    ...
    ui->zortcoinAtStartup->setToolTip(ui->zortcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->zortcoinAtStartup->setText(ui->zortcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openZortcoinConfButton->setToolTip(ui->openZortcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ZortcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->zortcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openZortcoinConfButton_clicked()
{

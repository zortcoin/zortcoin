...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, ZortcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &ZortcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &ZortcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &ZortcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &ZortcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &ZortcoinGUI::updateWalletStatus);
    connect(gui, &ZortcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);

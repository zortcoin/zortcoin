...
#ifndef ZORTCOIn_WALLET_WALLET_H
#define ZORTCOIn_WALLET_WALLET_H
...
public:
     ...
     * on this zortcoin node, and set to 0 for transactions that were created
...
#endif // ZORTCOIn_WALLET_WALLET_H

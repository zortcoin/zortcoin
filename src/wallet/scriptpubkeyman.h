...
#ifndef ZORTCOIn_WALLET_SCRIPTPUBKEYMAN_H
#define ZORTCOIn_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Zortcoin Core wallet was originally a collection of unrelated private
...
#endif // ZORTCOIn_WALLET_SCRIPTPUBKEYMAN_H

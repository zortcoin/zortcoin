...
#ifndef ZORTCOIn_WALLET_WALLETUTIL_H
#define ZORTCOIn_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! zortcoin from opening the wallet, thinking it was newly created, and
...
#endif // ZORTCOIn_WALLET_WALLETUTIL_H

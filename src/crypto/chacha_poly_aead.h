...
#ifndef ZORTCOIn_CRYPTO_CHACHA_POLY_AEAD_H
#define ZORTCOIn_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@zortcoin.
 *
 ...
 *
 * The chacha20-poly1305@zortcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@zortcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@zortcoin are relatively fast in
...
#endif // ZORTCOIn_CRYPTO_CHACHA_POLY_AEAD_H

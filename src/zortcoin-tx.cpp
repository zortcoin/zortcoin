...
static void SetupZortcoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zortcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zortcoin-tx [options] <hex-tx> [commands]  Update hex-encoded zortcoin transaction\n" +
            "or:     zortcoin-tx [options] -create [commands]   Create hex-encoded zortcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zortcoin transaction

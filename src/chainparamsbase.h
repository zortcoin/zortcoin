...
#ifndef ZORTCOIn_CHAINPARAMSBASE_H
#define ZORTCOIn_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between zortcoin-cli and zortcoind)
 * of a given instance of the Zortcoin system.
 */
...
#endif // ZORTCOIn_CHAINPARAMSBASE_H

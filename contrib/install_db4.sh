...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the zortcoin repository."
  exit 1
fi
...
# See https://github.com/zortcoin/zortcoin/issues/16064
...
echo 'When compiling zortcoind, run `./configure` in the following way:'
echo

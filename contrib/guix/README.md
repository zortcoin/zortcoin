# Bootstrappable Zortcoin Core Builds

This directory contains the files necessary to perform bootstrappable Zortcoin
Core builds.
...
- 24GB of free disk space on the partition that the Zortcoin Core git repository
  resides in
...
For a Zortcoin Core depends development environment, simply invoke
...
From the top of a clean Zortcoin Core repository:
...
To use dongcarl's substitute server for Zortcoin Core builds after having

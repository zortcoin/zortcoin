...
def main():
    ...
    # Filter out hosts with multiple zortcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple zortcoin ports' % (ip_stats(ips)), file=sys.stderr)
